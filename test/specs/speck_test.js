...
test('build mocha-chai specs', function(t) {
  t.plan(2);
  var actual_base = grunt.file.read('test/fixtures/specs/base_mochaChaiSpec.js');
  var expected_base = grunt.file.read('test/fixtures/expected/base_mochaChaiSpec.js');
  var actual_edge = grunt.file.read('test/fixtures/specs/edgeCases_mochaChaiSpec.js');
  var expected_edge = grunt.file.read('test/fixtures/expected/edgeCases_mochaChaiSpec.js');
